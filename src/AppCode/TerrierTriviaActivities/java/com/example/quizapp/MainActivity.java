...
//All Category Quizdata
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create quizArray from QuizData and corresponding category
        if(quizCategory==0) {
    ...
    public void checkAnswer(View view){
        ...
        if(btnText.equals(rightAnswer)){
          ...
          final MediaPlayer wrongsoundMP = MediaPlayer.create(this, R.raw.wrongsound);
                    wrongsoundMP.start();
    ...
    // The return button goes back to Start Activity
